...
// IT_task3_6s_sem.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CITtask36ssemApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CITtask36ssemApp

CITtask36ssemApp::CITtask36ssemApp()
{
...
// Единственный объект CITtask36ssemApp

CITtask36ssemApp theApp;


// Инициализация CITtask36ssemApp

BOOL CITtask36ssemApp::InitInstance()
{
